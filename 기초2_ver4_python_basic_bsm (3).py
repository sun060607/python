...
for row in data:
  if row[2] != '':
    ...
    if row[0].split('-')[1] == '06':
      result6.append(float(row[2]))
    if row[0].split('-')[1] == '07':
      result7.append(float(row[2]))
    if row[0].split('-')[1] == '08':
      result8.append(float(row[2]))
    if row[0].split('-')[1] == '09':
      result9.append(float(row[2]))
    if row[0].split('-')[1] == '10':
      result10.append(float(row[2]))
    if row[0].split('-')[1] == '11':
      result11.append(float(row[2]))
    if row[0].split('-')[1] == '12':
      result12.append(float(row[2]))
f.close()
# 그래프를 추가하세요

plt.boxplot([result1,result2,result3,result4,result5,result6,result7,result8,result9,result10,result11,result12])
plt.legend()
plt.show()
